...
## Pre deployment Manual step for AGIS-43.
...
|2| Set the following values on Label => 'PurchaseOrderConnection' | | | | | | | |
|3| Set the following values on Name => 'PurchaseOrderConnection' | | | | | | | |
|4(a)| Set the following values for DEV => https://phm-qtc-po-exchng-svc-eapi-dev.us-e2.cloudhub.io/eapi/qtcpo  | | | | | | | |
|4(b)| Set the following values for PRE-QA => https://phm-qtc-po-exchng-svc-eapi-preqa.us-e2.cloudhub.io/eapi/qtcpo  | | | | | | | |
